...
import { ArrowUpDown, MoreHorizontal, Package, Truck, Clock, CheckCircle, AlertCircle } from "lucide-react"
...
export const columns: ColumnDef<Order>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (!shipmentId) {
        return <Badge variant="outline" className="text-orange-600">Nevytvořena</Badge>
      }
